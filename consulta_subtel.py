...
st.title('Interfaz de Consulta SUBTEL - SAGEC')

# Descripción de la aplicación
st.write("""
Esta interfaz permite al usuario Consulta SUBTEL acceder a informes, paneles de control y revisar validaciones en la plataforma SAGEC.
""")
